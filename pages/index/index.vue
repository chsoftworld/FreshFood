	...
	<view>
		...
		<view class="flex index-header">
			...
			<view class="" style="width: 70%;font-size: 10px;color: #c9e1e1;padding-left: 20upx;">
				...
				<view class="">
					<text class="cuIcon-location text-white padding-xs"></text>湖北省黄石市下陆区湖北理工学院
				</view>
			</view>
		</view>
		...
		<view class="VerticalBox">
			<scroll-view class="VerticalNav nav" scroll-y scroll-with-animation :scroll-top="verticalNavTop">
				<view class="cu-item" :class="index==tabCur?'text-black cur':'text-gray'" v-for="(item,index) in list" :key="index" @tap="TabSelect"
				 :data-id="index">
					{{item.name}}
				</view>
			</scroll-view>
			...
			<scroll-view class="VerticalMain" scroll-y scroll-with-animation>
				...
				<view class="" style="broder-radius: 50%">
					<image src="../../static/index/index-banner.png" mode="" style="width: 100%;height: 250upx;border-radius: 5px"></image>
				</view>
				...
				<view class="flex solid-bottom" v-for="(item, index) in 10" :key="index" style="padding: 30upx 0;">
					<view class="">
						<image class="shoping-img" src="../../static/index/shopping.png" mode="aspectFill" style="border-radius:3px"></image>
					</view>
					...
					<view class="bg-white" style="height: 500upx;padding-left: 30upx;" >
						<view class="flex solid-bottom">
							<view class="buy-model-img">
								<image style="width: 200upx;height: 200upx;" src="../../static/index/shopping.png" mode="aspectFill"></image>
							</view>
						...
						<view class="" style="margin-left: -30upx;">
							<image src="../../static/index/submit.png" mode="" style="height: 100upx;width: 100%;"></image>
						</view>
